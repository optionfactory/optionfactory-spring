...
public class PemTest {
    ...
    public void canLoadKeyStoreWithKeyAndCertificate() throws GeneralSecurityException {
        ...
        Assertions.assertEquals(Set.of("default"), new HashSet<>(Collections.list(ks.aliases())));

        final var entry = ks.getEntry(Pem.DEFAULT_ALIAS, new KeyStore.PasswordProtection("unused".toCharArray()));
        
        Assertions.assertEquals(KeyStore.PrivateKeyEntry.class, entry.getClass());
        Assertions.assertEquals(1, ((KeyStore.PrivateKeyEntry) entry).getCertificateChain().length);
    }
    ...
    public void canLoadTrustedCertificates() throws GeneralSecurityException {
        ...
        Assertions.assertEquals(Set.of("default.1", "default.2"), new HashSet<>(Collections.list(ks.aliases())));
        Assertions.assertEquals(KeyStore.TrustedCertificateEntry.class, ks.getEntry("default.1", null).getClass());
        Assertions.assertEquals(KeyStore.TrustedCertificateEntry.class, ks.getEntry("default.2", null).getClass());
    }
